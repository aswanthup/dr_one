        ...
        <div className="hospitaladmin_right">
          ...
          <div className="manage flex">
            ...
            <div className="hospitaladmin_cards flex">
              <a
                href=""
                className="hospitaladmin_card hospitaladmin_card1 flex"
              >
                <div>
                  <div className="hospitaladmin_number hospitaladmin_number1 flex">
                    <h2>24</h2>
                  </div>
                </div>
              ...
              <a
                href=""
                className="hospitaladmin_card hospitaladmin_card2 flex"
              >
                <div>
                  <div className="hospitaladmin_number hospitaladmin_number2 flex">
                    <h2>24</h2>
                  </div>
                </div>
              ...
              <a
                href=""
                className="hospitaladmin_card hospitaladmin_card3 flex"
              >
                <div>
                  <div className="hospitaladmin_number hospitaladmin_number3 flex">
                    <h2>24</h2>
                  </div>
                </div>
