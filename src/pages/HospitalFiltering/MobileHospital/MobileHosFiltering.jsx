            ...
            <div className='MobileLabAlign'>
                ...
                <div className='MobileLabAlignFilter'>
                    ...
                    <div className='MobileLabAlignFilterSec'>
                        <select onChange={handleTypeChanges} className='MobileLabAlignFilterSecButton' name="type" id="">
                    ...
                    {hospitalsFilter?.length > 0 || filters.type || filters?.speciality?.length > 0 || filters?.features?.length > 0 ?
                        hospitalsFilter?.length > 0 && !notFound ?
                            hospitalsFilter?.map((details, index) =>
                                <HospitalCard key={index} data={{ details: details, hospital: true }} />
                            )
