                    ...
                    <div className="mainadmindoctordatas_profile flex">
                        ...
                        <div className="mainadmindoctordatas_profile_data flex">
                            ...
                            <div className='flex'>  <h2>
                                {DoctorData?.name}</h2> <h4 className='highlight_data' style={{ background: "#2A9D8F", color: "white", marginLeft: "10px" }}>{DoctorData?.sector.slice(0, 3).toUpperCase()}</h4></div>

                            <h4 className='highlight_data' style={{ background: "#3A65FD", color: "white", }}>{DoctorData?.education_qualification}</h4>
                            ...
                            <div className='flex'>
                                ...
                                <div className='flex texticonset' style={{ marginLeft: "20px" }}>
                                    <i class="fi fi-sr-city"></i>    <h4 style={{ marginLeft: "10px" }}>{DoctorData?.phone_office}</h4>
                                </div>
                            </div>
                                ...
                                currentAvailability?.map((ele, index) =>
                                    <div className="hospitaltime flex">
                                        ...
                                        <div className='hospitaltimebuttongapSet'>
                                            ...
                                            <div onClick={() => { DeleteTimeConfirm({ id: ele.id, index: index },) }} className='hospitaltimebuttongapSetDltBtn'>
