...
<Navbar /> 
    ...
    <div className="doctor-banner">
      <div className="second-main-head doctor-head">
        <h1>Find <span> Doctors</span>  From</h1>
        <h1>  Your Location </h1>
      </div>
      <div className="doctor-details flex">
        <div className="just flex" style={{gap: '40px'}}>
          <div>
            <div><h1 style={{color: 'white'}}>30 +</h1></div>
            <div><h3>Consultations</h3></div>
          </div>
          <div>
            <div><h1 style={{color: 'white'}}>34 +</h1></div>
            <div><h3>Specialties</h3></div>
          </div>
          
        </div>
        <div className="hello">
          <img className="doctor-main-img" src="images/doc-main.png" alt="" />
        </div>
      </div>
    </div>
...
<input className="Doctor-Location-input" type="text" placeholder='Kozhikode'/>
...
<div className="second-main-head">
        <h1>Find Doctor by <span className="color-blue">Specialties </span></h1>
</div>
...
<i class="ri-arrow-right-line"></i>
  ...
  <div className="mobile-second-heading">
                <h1>Find <span className='color-blue '> Doctors</span> From Your Location</h1>
              </div>
...
<div className="doctor-details flex">
        <div className="just flex" style={{gap: '40px'}}>
          <div>
            <div><h1 style={{color: 'white'}}>30 +</h1></div>
            <div><h4>Consultations</h4></div>
          </div>
          <div>
            <div><h1 style={{color: 'white'}}>34 +</h1></div>
            <div><h4>Specialties</h4></div>
          </div>
        </div>
       </div>
</div>
