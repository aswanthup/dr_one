...
<Navbar/> 
          ...
          <div className="container container-search flex">
            <div className="Search-box flex">
              <div className="location-section flex">
                ...
                <input className="Location-input" type="text" placeholder='Kozhikode'/>
        ...
        <div className="container-second Features">
          <div className="second-main-head">
            <h1>Explore Our <span>Features</span></h1>
          </div>
          <div className="home-cards flex ">
            <div className="home-card">
              <div className="image-section"><img src="/images/doc.jpg" alt="" /></div>
              <div className="button-section flex">
                <div className="card-icon flex"><img src="images/doc-icon.svg" alt="" /></div>
            ...
            <div className="home-card">
              <div className="image-section"><img src="/images/lab.jpg" alt="" /></div>
              <div className="button-section flex">
                <div className="card-icon flex"><img src="images/test.png" alt="" /></div>
                <a className="card-button flex" href>
                  <h4>Find Labs</h4>
                </a>
              </div>
            ...
            <div className="home-card">
              <div className="image-section"><img src="/images/med.jpg" alt="" /></div>
              <div className="button-section flex">
                <div className="card-icon flex"><img src="images/med1.svg" alt="" /></div>
                <a className="card-button flex" href>
                  <h4>Get Medicines</h4>
                </a>
              </div>
          ...
          <div className="home-hospital flex">
            ...
            <div className="home-hospital-title">
              <h2>Find Best <span>Hospital</span></h2>
              <h2>Near You</h2>
            </div>
            <div className="home-hospital-button flex">
              <a href=" " className='card-button flex'><h4>Hospital</h4></a>
        ...
        <div className=" container-second Specialties">
          ...
          <div className="second-main-head second-main-head2 flex">
            <h1>Our <span>Specialties</span></h1>
          ...
          <div className="home-specialties-cards flex" style={{marginTop: '5vh'}}>
            <div className="home-specialties-card flex">
              <div className="home-specialties-image">
        ...
        <div className="container-second home-lab">
          <div className="second-main-head">
            <h1>Popular <span>lab tests</span> &amp; profiles</h1>
          </div>
          ...
          <div className="lab-content flex">
            <div className="lab-left">
              ...
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>CBC(Complete
                      Blood Count)
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>Thyroid Profile Total(T3,
                      T4 &amp; TSH)
                    </a></h4>
                </div>
              </div>
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>LFT (Liver Function Test)
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>Diabetes Screening
                      (HbA1C &amp; Fasting Sugar)
                    </a></h4>
                </div>
              </div>
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>Lipid Profile
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>COVID-RTPCR
                    </a></h4>
                </div>
              </div>
            </div>
            <div className="lab-right">
              ...
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>Ultrasound Whole Abdomen
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>Electrocardiography
                    </a></h4>
                </div>
              </div>
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>X-Ray Chest PA View
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>MRI Brain
                    </a></h4>
                </div>
              </div>
              <div className="lab-datas flex">
                <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>NCCT Scan Brain
                    </a></h4>
                </div>
                <div className="lab-data-right flex">
                  <div><i className="ri-arrow-right-circle-line" /></div><a href>
                  </a><h4><a href>MRI Cervical Spine
                    </a></h4>
                </div>
              </div>
            </div>
        ...
        <div className="container-second diagnostic">
          <div className="second-main-head second-main-head2 flex">
            <h1>Top Booked <span> Diagnostic</span> Tests</h1>
            <div className="explore-more">
              <a href="">
                <h4>Explore More</h4>
              </a>
          ...
          {/* Search Bar */}
            ...
            {/* Features */}
              ...
              <div className="mobile-second-heading">
                <h1>Explore our <span className='color-blue '> Features</span></h1>
              </div>

               <div className="mobile-features-card flex">
                     <div className="mobile-features-button">
                           <a href=""><h4>Search Doctor</h4></a>
                     </div>
               </div>
               ...
               <div className="mobile-features-card3 flex">
                     <div className="mobile-features-button">
                           <a href=""><h4>Get Medicines</h4></a>
                     </div>
               </div>

               <div className="mobile-features-card4 flex">
                     <div className="mobile-features-button">
                           <a href=""><h4>Search Hospital</h4></a>
                     </div>
               </div>
             {/*End Features */}
...
{/* tests */}
<div className="mobile-second-heading">
                <h1>Popular<span className='color-blue '>Lab Tests</span>&Profiles</h1>
              </div>
...
<div className="mobile-test">
   ...
   <div className="lab-data-left flex">
                  <div><i className="ri-arrow-right-circle-line" /></div>
                  <a href><h4>CBC(Complete
                      Blood Count)
                    </h4></a>
                </div>
...
<div className="mobile-second-heading">
                <h1>Top Booked<span className='color-blue '>Diagnostic Tests</span></h1>
              </div>
