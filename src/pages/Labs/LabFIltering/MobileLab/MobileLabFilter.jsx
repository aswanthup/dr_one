        ...
        <div className='MobileLabAlign'>
            ...
            <div className='MobileLabAlignFilter'>
                ...
                <div className='MobileLabAlignFilterSec'>
                    <button onClick={openModal} value={"services"} className='MobileLabAlignFilterSecButton'>Services</button>
                    <button onClick={openModal} value={"features"} className='MobileLabAlignFilterSecButton'>Features</button>
                </div>
            </div>
            ...
            <Modal open={OpenModals?.services || OpenModals?.features} onClose={closeModal} className='MobileLabAlignModal'>
