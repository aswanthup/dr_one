  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/hospitaladminnotification' element={<Hospitaladminnotification />} ></Route>
        <Route path='/hospitaladmindoctorlist' element={<Hospitaladmindoctorlist />} ></Route>
        <Route path='/hospitaldetails' element={<Hospitaldetails   />} ></Route>
        <Route path='/hospitaladmindoctorcard' element={<Hospitaladmin_doctor_card />} ></Route>
        <Route path='/hospitaladmindoctordetails' element={<Hospitaladmindoctordetails />} ></Route>
        <Route path='/hospitaladminregistration2' element={<Hospitaladminregistration2 />} ></Route>
        <Route path='/hospitaladminadddoctor' element={<Hospitaladminadddoctor />} ></Route>
...
<Route path='/doctoradminregistration1' element={<Doctoradminregistration1 />} ></Route>
<Route path='/doctoradminregistration2' element={<Doctoradminregistration2 />} ></Route>
<Route path='/doctoradmin' element={<Doctoradmin />} ></Route>

{/* Pharmacy admin */}

<Route path = '/pharmacyadmin' element={<Pharmacyadmin />} ></Route>
<Route path='/pharmacyadminregister2' element={<Pharmacyadminregister2 />} ></Route>

<Route path='/pharmacyadminregister1' element={<Pharmacyregistration1 />} ></Route>

{/* Lab admin */}


<Route path='/labadminregistration1' element={<Labadminregistration1 />} ></Route>
